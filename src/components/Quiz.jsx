...
function Quiz() {
  ...
  return (
    <>
        <div  style={{height: '100vh',border: '1px solid',backgroundImage: 'url("https://charaklive.b-cdn.net/wp-content/uploads/2021/07/Quiz-1200x450.jpg")',backgroundRepeat: 'no-repeat',backgroundSize: '100% 100%'}}>
        <br /> <br/>      <br />  <h1 className=' bd-flex justify-content-center mt-5 ' style={{marginLeft:'700px'}}>Quiz App</h1>
       <br /> <br/>      <br /> <br/>
            <div className='quizbox container ' style={{height: '70vh',width: '130vh'}}>
                ...
                <Row>
                    ...
                    <Col className='ms-3 mt-4'>
                        ...
                        <div className='float-end'style={{marginLeft:'800px'}}><button onClick={next} className='button1 border rounded'>Next</button></div>
                    </Col>
                </Row>
                </>
                }
